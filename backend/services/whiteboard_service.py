...
class WhiteboardService:
    ...
    async def upload_export(self, session_id: str, file_bytes: bytes,
    ...
    async def upload_snapshot(self, session_id: str, image_bytes: bytes) -> str:
        """Upload a whiteboard screenshot to GCS."""
        return await self.upload_export(session_id, image_bytes, "snapshot.png", "image/png")
